              ...
              <div className="flex justify-center space-x-6">
                ...
                >
                  <svg className="h-10 w-10" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_401_60)">
                      <rect
                        width="128"
                        height="128"
                        rx="14"
                        className="fill-muted-foreground group-hover:fill-primary transition-colors"
                      />
                      <g clipPath="url(#clip1_401_60)">
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M24.9834 98.775C36.4512 108.144 49.7072 113.49 63.8291 113.49C84.8448 113.49 103.922 101.641 118.077 82.3521C112.1 74.2065 105.244 67.3879 97.7384 62.2305L85.6777 68.2867C88.2705 72.343 89.7717 77.1711 89.7717 82.3521C89.7717 96.7469 78.158 108.417 63.8291 108.417C52.6953 108.417 43.1992 101.373 39.5193 91.4718L24.9834 98.775V98.775ZM54.9023 83.745C55.1894 85.6367 56.074 87.3966 57.434 88.7707C59.1328 90.4742 61.4291 91.4294 63.8291 91.42C68.8218 91.42 72.8593 87.359 72.8593 82.3427C72.8593 79.8816 71.8852 77.6464 70.2947 76.0088L54.8976 83.745H54.9023Z"
                          className="fill-white"
                        />
                        <path
                          d="M38.4838 76.598L104.237 44.9898L89.7854 14.9297L82.3222 41.4934L73.3531 22.8306L65.8851 49.3943L56.916 30.7315L49.4481 57.2952L40.479 38.6324L33.011 65.1961L24.0419 46.5333L12 89.3317L28.4371 81.4308L38.4838 76.6028V76.598Z"
                          className="fill-white"
                        />
                      </g>
                    </g>
                    <defs>
                      ...
                      <clipPath id="clip1_401_60">
                        <rect width="106.076" height="98.5611" fill="white" transform="translate(12 14.9297)" />
                      </clipPath>
                    </defs>
                  </svg>
                </Link>
